...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        loss += 0.5 * reg *(rsum(W1) + rsum(W2) + rsum(W3))
        ...
        grads['W3'],grads['W2'],grads['W1'],grads['b3'],grads['b2'],grads['b1'] \
                = dW3 + reg * W3, dW2 + reg * W2, dW1 + reg * W1, db3, db2, db1
        ############################################################################
        #                             END OF YOUR CODE                             #
        ############################################################################
